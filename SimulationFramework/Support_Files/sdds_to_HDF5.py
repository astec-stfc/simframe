...
class convertSDDS():
    ...
    def sdds_to_hdf5(self, filename, middle=0, end=0):
        ...
        rbf.hdf5.write_HDF5_beam_file(self.global_parameters['beam'], self.global_parameters['master_subdir'] + '/' + HDF5filename, centered=False, sourcefilename=elegantbeamfilename, pos=middle, zoffset=end, toffset=(-1*np.mean(self.global_parameters['beam'].t)))
