...
lattice.loadSettings('Lattices/CLA10-BA1_OM.def')
lattice.generator.number_of_particles = 2**(3*4)
lattice.generator.charge = 100e-12
# lattice.change_Lattice_Code('All','elegant', exclude=['injector400'])
# lattice.change_Lattice_Code('All','GPT', exclude=['injector400','L02','L03','L04','L4H','VBC','S07'])
lattice.change_Lattice_Code('All','GPT', exclude=[])
# print(lattice.latticeObjects.keys()[3:])
for l in list(lattice.latticeObjects.values())[3:]:
    # print(l)
    lo = l#lattice.latticeObjects[l]
    lo.file_block['charge']['space_charge_mode'] = None
